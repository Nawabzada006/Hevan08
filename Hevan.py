...
def logo():  
    print("\033[1;35m 
                      _                 _        
 print("\033[1;35m| \ | |                   | |               | |       
print("\033[1;35m |  \| | __ ___      ____ _| |__ ______ _  __| | __ _  
print("\033[1;35m | . ` |/ _` \ \ /\ / / _` | '_ \_  / _` |/ _` |/ _` | 
print("\033[1;35m| |\  | (_| |\ V  V / (_| | |_) / / (_| | (_| | (_| | 
print("\033[1;35m |_| \_|\__,_| \_/\_/ \__,_|_.__/___\__,_|\__,_|\__,_| 
  print("\n                     \033[38;2;124;252;0mCreated By: UNB34T9BL3 BOII N4W9BZ4D4 INSID3")
    print("-----------------------------------------------------------------------")
...
def main():
    ...
    logo()
    print('-------------------------------------------')
    print("\033[1;34m THe >>  THE N4W9B BRAND 0N FIR3")
    print('-------------------------------------------')
    coki = input(' [+] Cookies : ')
    cookies={'cookie': coki}
